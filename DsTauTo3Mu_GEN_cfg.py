...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/b/bjoshi/DsTau3Mu_13TeV_MC2018_SIM.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
     ...
     #decay_table = cms.string('file:/lustrehome/fsimone/CMSSW_9_4_5/SingleMuon/DsTau3Mu_MC2016/DECAY_2014_NOLONGLIFE.DEC'),
            particle_property_file = cms.FileInPath('GeneratorInterface/EvtGenInterface/data/evt_2014.pdl'),
     #particle_property_file = cms.string('file:./evt_2014.pdl'),
...
process.MuFilter = cms.EDFilter("MCParticlePairFilter",
    MinPt = cms.untracked.vdouble(2.7, 2.7), #using 2.7 I got 5 over 10000 events
...
#process.ProductionFilterSequence = cms.Sequence(generator * DsFilter * MuFilter)
